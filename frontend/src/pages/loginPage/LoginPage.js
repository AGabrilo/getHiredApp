    ...
    return (
        <>
            <Box sx={{ display: 'flex', justifyContent: 'center', width: '100%', flexWrap: 'wrap', backgroundColor: '#0d1a30', alignItems: 'center', px: 5 }}>
                <Typography variant='h3' sx={{ mt: 7, mb: 2, color: '#fafafa' }} align="center">GetHired Sign up/in</Typography>
                <Box sx={{ display: 'flex', justifyContent: 'space-around', width: '100%', flexWrap: 'wrap', my: 7 }}>
                    <LoginForm />
                    <Typography variant='h5' sx={{ my: 2, color: '#fafafa' }}>Or...</Typography>
                    <RegisterForm />
                </Box>
            </Box>
