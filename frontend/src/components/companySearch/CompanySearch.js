    ...
    return (
        <Box sx={{ width: '100%', mx: 5, p: 4, backgroundColor: 'white', borderRadius: 2.5 }}>
            ...
            <Stack
                ...
                sx={{ width: '100%' }}
            >
                <TextField label="Company name" variant="outlined" fullWidth sx={{ backgroundColor: '#e9e8eb' }} />

                <TextField label="Company location" variant="outlined" fullWidth sx={{ backgroundColor: '#e9e8eb' }} />
