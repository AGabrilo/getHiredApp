...
function CompanyDialogForm(props) {
  ...
  const initialValues = { name: company.name, description: company.description, employersNum: company.employersNum, location: { city: company.location ? company.location.city : '', country: company.location ? company.location.country: '' } }
